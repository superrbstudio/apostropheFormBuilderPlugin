...
<?php echo jq_form_remote_tag(array(
  ...
  'script' => 'true', 
  'complete' => '$("#a-form-field-options-'.$a_form_field->getId().' .a-form-field-options input:last").focus()', 
  ), array('id' => 'a-form-field-options-'.$a_form_field->getId())) ?>
  <?php echo $a_form_field_options_form->renderGlobalErrors(); ?>
	
	<ul class="a-form-field-options <?php echo $a_form_field->getType() ?>">
  <?php $n=1; foreach($a_form_field_options_form['options'] as $field): ?>
   	<li>
   	  <?php echo $field['id'] ?>
  ...
  <?php echo input_hidden_tag('field_id', $a_form_field->getId(), array()) ?>
  
  <input type="submit" value="save" class="a-submit" />

<?php if ($a_form_field->getType() == 'select'): ?>
...
<?php if ($a_form_field->getType() == 'select_radio'): ?>	
	<script type="text/javascript">
...
<?php if ($a_form_field->getType() == 'select_checkbox'): ?>	
	<script type="text/javascript">
