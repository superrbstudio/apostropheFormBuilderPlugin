...
<?php echo jq_form_remote_tag(array(
  'url' => ($a_form_fieldset->isNew()) ? 'aForm/addField' : 'aForm/updateField', 
  'update' => ($a_form_fieldset->isNew()) ? 'a-form-'.$a_form->getId() : 'a-form-field-'.$a_form_fieldset->getId(),
  'script' => 'true', 
...
<ul class="a-form-field">
	...
	<?php foreach ($a_form_fieldset_form as $field): ?>
...
<?php else: ?>
  <li class="cancel"> or <?php echo jq_link_to_remote('cancel', array(
    'url' => 'aForm/showField?id='.$a_form_fieldset->getId(), 
