...
<li class="drag"><?php echo jq_link_to_function('<span class="icon"></span>' . __('Drag', array(), 'apostrophe'), '', array('class' => 'a-btn icon no-label a-drag no-bg alt', 'title' => 'Drag to Order',  )) ?></li>
<li class="delete"><?php echo jq_link_to_remote('<span class="icon"></span>' . __('Delete', array(), 'apostrophe'), array(
...
<li class="edit"><?php echo jq_link_to_remote('<span class="icon"></span>' . __('Edit', array(), 'apostrophe'), array(
...
<li>
	<ul class="a-form-field <?php echo $aFormFieldset->getType() ?>">
		<?php include_partial('aForm/fieldset'.sfInflector::camelize($aFormFieldset->getType()), array('aFormFieldset' => $aFormFieldset, 'form' => $aFormFieldset->getForm(), 'disabled' => true)) ?>
	</ul>
</li>